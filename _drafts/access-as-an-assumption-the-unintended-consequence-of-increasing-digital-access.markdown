...
![SDG9 small.jpg](/uploads/SDG9%20small.jpg){:.float-left} `Photo source www.sdgldnont.ca`  In our quest to increase digital access we tend to focus on the digital dividends, rather than the negatives that could arise from digital access. We are understandably excited about [edging closer to universal access](https://www.itu.int/en/mediacentre/Pages/2018-PR40.aspx), or the new business opportunities and improvements to service provision that accompany it. But while we are improving in our endeavor to ensure safety and security, combat the gender digital divide, and ensure not to leave out PWDs (all great stuff!), we could be overlooking more negative consequences of increased digital access.
