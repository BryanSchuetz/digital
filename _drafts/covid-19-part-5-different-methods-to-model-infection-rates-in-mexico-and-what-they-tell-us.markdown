...
When using the Imperial College model with the case fatality ratio of the Diamond Princess cruise ship fit to the number of found cases and deaths in Mexico City, as of May 1, the estimated percentage of the cumulative number of infected of the entire population is 5.00 percent (450,813 individuals), with a 95 percent confidence interval of 1.9 to 12.3 percent (174,969 to 1,110,189 individuals). Using the mean, this would suggest that in Mexico City a total of 10 percent of all cases have been detected. This is largely in line with what several studies have suggested as an appropriate correction number.
