...
A clear example is CISCO's work in 2017, there they supported   these software or tools and lessYet at the same time, they have have pushed organizations to naturally integrate their use, digitizing processes, but not transforming their models, it is no coincidence that CISCO in 2017 worked with 14 local governments in India in its digital transformation (Digital Effects, 2017), redefining the connectivity model in cities through Wifi cloudization, supporting the change to have access to a new business model around connectivity devices.
