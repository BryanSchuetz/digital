...
In conversations with the team, I learned that the project has several indicators included in their annual  monitoring and evaluation plan focused on gender integration and many of them are indeed disaggregated by sex. While this is critical, getting buy-in from governments and institutions to implement gender-inclusive activities remains a challenge. Although disaggregating data by gender to understand variances in healthcare needs is possible using SISNU, there is still room for improvement in utilizing these data to understand the impacts and barriers on their systems. Even though digital technologies empower the government to access and centralize information from health clinics across Haiti—*which is momentous on its own right*—age-old social norms can still hinder true change of equitable access to healthcare.
