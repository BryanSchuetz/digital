...
*Hanson Johnson is the founder and CEO of Start Innovation Hub. He is also the country mentor for Google Developers in Nigeria, where he works with the Developer Relations Team at Google to ensure developer welfare and supports local developers to build sustainable technology ecosystems in their local communities. Since 2010, he has contributed to the development of the technology ecosystem in Nigeria as a software engineer, ecosystem builder, manager, and mentor. To reach out to Hanson, feel free to message him on [Facebook](https://www.facebook.com/nextdeegit) or[ Twitter](https://twitter.com/nextdeegit).*