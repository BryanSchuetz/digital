...
Last month, the [Global Alliance for Improved Nutrition (GAIN)](https://www.gainhealth.org/homepage) and Johns Hopkins University (JHU), in collaboration with [iTech Mission,](http://www.itechmission.org/) presented a soon-to-be-launched FSD during a public event at IFPRI’s headquarters. The FSD is a data platform designed to:
